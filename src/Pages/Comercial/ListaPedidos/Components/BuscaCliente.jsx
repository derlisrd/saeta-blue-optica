...
function BuscaCliente({setSelectCliente}) {
    ...
    const insertarCliente = (e,value)=> {
        if(value){
            setSelectCliente(value?.id_cliente)
        }else{
    ...
    return (<Autocomplete
        ...
        renderInput={(params) => <TextField fullWidth {...params}  size="small" onChange={e=>setSearch(e.target.value)} label="Buscar por codigo, ruc o nombre" />}
    />);
}
