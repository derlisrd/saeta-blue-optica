      ...
      <form onSubmit={enviar}>
        ...
        <DialogContent>
            <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                    <TextField id="nombre_deposito" error={error.code===1} autoFocus name="nombre_deposito" onChange={change} value={formEdit.nombre_deposito} required autoComplete="off" fullWidth label="Documento" />
                </Grid>
            </Grid>
        </DialogContent>
